...
export function speechDirection(info: SpeechInfo) {
  if (info.speechType === 'character') return `Реплику произносит в кадре ${info.speaker || 'один выбранный герой'}. Только этот герой естественно двигает губами. У всех остальных персонажей рты закрыты на протяжении всего плана: без артикуляции, движения губ, разговора или пения. Лицо говорящего должно быть видно. Звук будет наложен отдельно; не добавляй свою речь, пение или субтитры.`;
