...
export const WORKFLOW=[...STAGES.slice(0,7).map((title,id)=>({id,title})),{id:9,title:'Аниматик'},{id:7,title:STAGES[7]},{id:10,title:'Титры'},{id:8,title:STAGES[8]}];
...
export const workflowReady=(p:Project,stage:number)=>stage===10?p.items.some(i=>i.stage===5&&participates(p,i)):stageReady(p,stage===9?6:stage);
